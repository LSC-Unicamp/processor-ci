...
pipeline {
    ...
    stages {
        stage('Git Clone') {
            steps {
                sh 'rm -rf Taiga'
                sh 'git clone --recursive https://gitlab.com/sfu-rcl/Taiga Taiga'
            }
        }
                        ...
                        stage('Síntese e PnR') {
                            steps {
                                dir("Taiga") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p Taiga -b colorlight_i9'
                                }
                            }
                        }
                        stage('Flash colorlight_i9') {
                            steps {
                                dir("Taiga") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p Taiga -b colorlight_i9 -l'
                                }
                            }
                        }
                        ...
                        stage('Síntese e PnR') {
                            steps {
                                dir("Taiga") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p Taiga -b digilent_nexys4_ddr'
                                }
                            }
                        }
                        stage('Flash digilent_nexys4_ddr') {
                            steps {
                                dir("Taiga") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p Taiga -b digilent_nexys4_ddr -l'
                                }
                            }
                        }
