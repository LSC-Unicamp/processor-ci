...
pipeline {
    ...
    stages {
        stage('Git Clone') {
            steps {
                sh 'rm -rf picorv32'
                sh 'git clone --recursive https://github.com/YosysHQ/picorv32 picorv32'
            }
        }
        ...
        stage('Simulation') {
            steps {
                dir("picorv32") {
                    sh "iverilog -o simulation.out -g2005  -s   picorv32.v "
                }
            }
        }
                        ...
                        stage('Síntese e PnR') {
                            steps {
                                dir("picorv32") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p picorv32 -b colorlight_i9'
                                }
                            }
                        }
                        stage('Flash colorlight_i9') {
                            steps {
                                dir("picorv32") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p picorv32 -b colorlight_i9 -l'
                                }
                            }
                        }
                        ...
                        stage('Síntese e PnR') {
                            steps {
                                dir("picorv32") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p picorv32 -b digilent_nexys4_ddr'
                                }
                            }
                        }
                        stage('Flash digilent_nexys4_ddr') {
                            steps {
                                dir("picorv32") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p picorv32 -b digilent_nexys4_ddr -l'
                                }
                            }
                        }
