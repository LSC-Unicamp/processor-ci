...
pipeline {
    ...
    stages {
        stage('Git Clone') {
            steps {
                sh 'rm -rf mriscv'
                sh 'git clone --recursive https://github.com/onchipuis/mriscv mriscv'
            }
        }
                        ...
                        stage('Síntese e PnR') {
                            steps {
                                dir("mriscv") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p mriscv -b colorlight_i9'
                                }
                            }
                        }
                        stage('Flash colorlight_i9') {
                            steps {
                                dir("mriscv") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p mriscv -b colorlight_i9 -l'
                                }
                            }
                        }
                        ...
                        stage('Síntese e PnR') {
                            steps {
                                dir("mriscv") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p mriscv -b digilent_nexys4_ddr'
                                }
                            }
                        }
                        stage('Flash digilent_nexys4_ddr') {
                            steps {
                                dir("mriscv") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p mriscv -b digilent_nexys4_ddr -l'
                                }
                            }
                        }
