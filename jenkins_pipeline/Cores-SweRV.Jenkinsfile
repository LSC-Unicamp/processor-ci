    ...
    stages {
        stage('Git Clone') {
            steps {
                ...
                sh 'git clone --recursive https://github.com/chipsalliance/Cores-SweRV Cores-SweRV'
            }
        }
                        ...
                        stage('Síntese e PnR') {
                            steps {
                                dir("Cores-SweRV") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p Cores-SweRV -b colorlight_i9'
                                }
                            }
                        }
                        stage('Flash colorlight_i9') {
                            steps {
                                dir("Cores-SweRV") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p Cores-SweRV -b colorlight_i9 -l'
                                }
                            }
                        }
                        ...
                        stage('Síntese e PnR') {
                            steps {
                                dir("Cores-SweRV") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p Cores-SweRV -b digilent_nexys4_ddr'
                                }
                            }
                        }
                        stage('Flash digilent_nexys4_ddr') {
                            steps {
                                dir("Cores-SweRV") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p Cores-SweRV -b digilent_nexys4_ddr -l'
                                }
                            }
                        }
