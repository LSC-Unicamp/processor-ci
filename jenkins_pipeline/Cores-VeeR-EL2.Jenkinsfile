    ...
    stages {
        stage('Git Clone') {
            steps {
                ...
                sh 'git clone --recursive https://github.com/chipsalliance/Cores-VeeR-EL2 Cores-VeeR-EL2'
            }
        }
                        ...
                        stage('Síntese e PnR') {
                            steps {
                                dir("Cores-VeeR-EL2") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p Cores-VeeR-EL2 -b colorlight_i9'
                                }
                            }
                        }
                        stage('Flash colorlight_i9') {
                            steps {
                                dir("Cores-VeeR-EL2") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p Cores-VeeR-EL2 -b colorlight_i9 -l'
                                }
                            }
                        }
                        ...
                        stage('Síntese e PnR') {
                            steps {
                                dir("Cores-VeeR-EL2") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p Cores-VeeR-EL2 -b digilent_nexys4_ddr'
                                }
                            }
                        }
                        stage('Flash digilent_nexys4_ddr') {
                            steps {
                                dir("Cores-VeeR-EL2") {
                                    ...
                                    sh 'python3 /eda/processor-ci/main.py -c /eda/processor-ci/config.json -p Cores-VeeR-EL2 -b digilent_nexys4_ddr -l'
                                }
                            }
                        }
