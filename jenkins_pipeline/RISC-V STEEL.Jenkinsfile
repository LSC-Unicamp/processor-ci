                ...
                stage('colorlight_i9') {
                    steps {
                        lock(resource: 'colorlight_i9') {
                            ...
                            dir("stell") {
                                sh 'python3 main_script_path -c /eda/processor-ci/config.json -p stell -b colorlight_i9'
                            }
                        }
                    }
                }
                stage('digilent_nexys4_ddr') {
                    steps {
                        lock(resource: 'digilent_nexys4_ddr') {
                            ...
                            dir("stell") {
                                sh 'python3 main_script_path -c /eda/processor-ci/config.json -p stell -b digilent_nexys4_ddr'
                            }
                        }
                    }
                }
